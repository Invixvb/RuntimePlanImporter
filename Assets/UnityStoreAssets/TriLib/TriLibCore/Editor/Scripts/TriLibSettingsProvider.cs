...
namespace TriLibCore.Editor
{
    public class TriLibSettingsProvider : SettingsProvider
    {
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            GUILayout.Label("Optional importers", EditorStyles.boldLabel);
            GUILayout.Label("TriLib importers not included in the main package.");
            EditorGUILayout.Space();
            ShowConditionalToggle("Enable runtime DAE (Collada) importing", "TRILIB_ENABLE_DAE_IMPORT");
            EditorGUILayout.Space();
            EditorGUILayout.Space();
